...
function PasswordSettings() {
  ...
  function handlePasswordReset() {
    try {
      const data = fetch(`${baseURL}/auth/update-password`, formData, {
        headers: {
        ...
        <div className="flex gap-5">
          ...
          <div className="w-full flex flex-col gap-8 items-start p-5 bg-white shadow-md shadow-gray-300 rounded-xl">
            <label htmlFor="" className="w-full flex flex-col gap-1">
              ...
              <input
                type="password"
                className="border-2 w-full border-gray-300 rounded-lg p-2 outline-none text-black"
              />
            </label>
            <label htmlFor="" className="w-full flex flex-col gap-1">
            ...
            <p>
              ...
              <button className="text-[#D470B7] cursor-pointer">
                Click here
              </button>
            </p>

            <button className="px-5 py-2 bg-[#D470B7] rounded-lg self-start text-white hover:bg-[#ad6c9b] transition-colors duration-300 cursor-pointer">
              Save Changes
            </button>
          </div>
        </div>
