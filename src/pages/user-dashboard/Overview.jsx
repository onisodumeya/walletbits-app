        ...
        <>
          ...
          <div className="flex bg-gray-100 gap-0 lg:gap-5 px-5 relative">
            ...
            <div className=" flex flex-col gap-10 w-full py-5 mb-25 lg:mb-0">
              <Headbar
                header="Dashboard"
                subHeader="See an overview of your dashboard"
              />
                    ...
                    {marketData.map((coin, index) => (
                      <tr key={index} className="border-b hover:bg-gray-50">
                        ...
                        <td className="p-3">
                          ...
                          <div
                            className={`text-xs inline-block ml-2 ${
                              coin.volumeChange > 0
                                ? "text-green-500"
                                : "text-red-500"
                            }`}
                        ...
                        <td className="p-3">
                          <ResponsiveContainer width={100} height={30}>
                            <LineChart
                              data={coin.chartTrend.map((val, i) => ({
                                x: i,
                                y: val,
                              }))}
                            >
                              <Line
                                ...
                                dataKey="y"
                                stroke={
                                  coin.change24h >= 0 ? "#16a34a" : "#dc2626"
                                }
                                strokeWidth={1}
                                dot={false}
                              />
