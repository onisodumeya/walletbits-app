...
function AccountCard({ title, fetchAmount, icon }) {
  ...
  useEffect(() => {
    ...
    //     try {
    //         const response = await fetchAmount();
    //         setAmount(response);
    //     } catch (error) {
  ...
  return (
    <div className="w-full h-[150px] rounded-2xl shadow-lg p-4 bg-white flex flex-col justify-between">
      ...
      <div className="mt-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <p className="text-3xl font-bold tracking-widest text-gray-400">
            ···
          </p>
        </div>
      </div>
